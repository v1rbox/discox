...
class cmd(Command):
    ...
    async def execute(self, arguments, message) -> None:
        embed = Embed(title="About me", description="I am a community created open source project started by Virbox, you can contribute to me by going to the Github repository.", color=0x00FF00)
